            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $agenda->municipio_destino }}</td>
                        <td class="text-center">
                            <a href="{{ route('agenda.pdf', $agenda->id) }}" target="_blank" class="btn btn-outline-primary btn-sm me-2">
                                <i class="fas fa-eye me-1"></i> Revisar PDF
                            </a>

                            <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#modalFirma{{ $agenda->id }}">
                            ...
                            <div class="modal fade" id="modalFirma{{ $agenda->id }}" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="{{ route('agenda.autorizar', $agenda->id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="modal-body text-start">
                                                <p class="text-muted small">Cargue la imagen de su firma para autorizar la agenda de <strong>{{ $agenda->nombre_completo }}</strong>.</p>
                                                <div class="mb-3">
                                                    <label class="form-label fw-bold">Archivo de firma (PNG o JPG)</label>
