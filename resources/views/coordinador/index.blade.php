...
<div class="container-fluid py-4">
            ...
            <div class="card border-0 shadow-sm bg-primary bg-opacity-10 text-primary p-3 h-100 cursor-pointer active" 
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="mb-0 fw-bold">{{ $agendas->where('estado', 'ENVIADA')->whereNull('observaciones_finanzas')->count() }}</h2>
                    </div>
            ...
            <div class="card border-0 shadow-sm bg-success bg-opacity-10 text-success p-3 h-100 cursor-pointer" 
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="mb-0 fw-bold">{{ $agendas->whereIn('estado', ['APROBADA_COORDINADOR', 'LIQUIDADA'])->count() }}</h2>
                    </div>
            ...
            <div class="card border-0 shadow-sm bg-danger bg-opacity-10 text-danger p-3 h-100 cursor-pointer" 
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="mb-0 fw-bold">{{ $agendas->where('estado', 'ENVIADA')->whereNotNull('observaciones_finanzas')->count() }}</h2>
                    </div>
    ...
    <div class="tab-content" id="pills-tabContent">
        ...
        <div class="tab-pane fade show active" id="pendientes" role="tabpanel">
            @include('coordinador.partials.tabla', [
                'lista' => $agendas->where('estado', 'ENVIADA')->whereNull('observaciones_finanzas'), 
                'tipo' => 'pendientes'
            ])
        </div>
        ...
        <div class="tab-pane fade" id="enviadas" role="tabpanel">
            @include('coordinador.partials.tabla', [
                'lista' => $agendas->whereIn('estado', ['APROBADA_COORDINADOR', 'LIQUIDADA']), 
                'tipo' => 'enviadas'
            ])
        </div>
        ...
        <div class="tab-pane fade" id="devueltas" role="tabpanel">
            @include('coordinador.partials.tabla', [
                'lista' => $agendas->where('estado', 'ENVIADA')->whereNotNull('observaciones_finanzas'), 
                'tipo' => 'devueltas'
            ])
        </div>
